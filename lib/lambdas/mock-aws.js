...
for (var k in AWS) {
    ...
    if ('A' >= k.charAt(0) && 'Z' <= k.charAt(0) &&
        ...
        module.exports[k] = createAwsConstructor(key);
    }
}
...
function bindAwsServiceCall(innerRounting, serviceName, obj, operation) {
    if (! innerRounting[operation]) {
...
MockResponse.prototype.nextPage = function nextPage() {
    ...
    return { on: function(e, f) {}, send: function() {
