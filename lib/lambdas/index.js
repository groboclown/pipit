...
/**
 * @return {string} null if no problem, otherwise the error message.
 */
module.exports.removeLambda = function removeLambda(lambdaName, qualifier) {
  if (!!qualifier) {
    // Remove a specific version.
    return lambdaDepot.removeByQualifier(lambdaName, qualifier);
  }
  return lambdaDepot.removeByName(lambdaName);
};
