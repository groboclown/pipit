...
function Lambda(functionName, description,
        role, codeFileLocation, memorySize, publish, runtime, handler, timeout, awsRequest,
        promiseLatch) {
    var t = this;
    var now = new Date();
...
module.exports.addLambda = function addLambda(functionName, description,
        role, codeFileLocation, memorySize, publish, runtime, handler, timeout, awsRequest) {
    if (module.exports.hasLambda(params[functionName])) {
    ...
    var lambda = new Lambda(functionName, description,
            role, codeFileLocation, memorySize, publish, runtime,
            handler, timeout, awsRequest,
            promiseLatch);
    promiseLatch.then(function() {
