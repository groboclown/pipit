...
var injections = {
    ...
    invokeBeforeFor: function(serviceName, apiName, awsReq) {
    ...
    invokeAfterFor: function(serviceName, apiName, awsReq, response) {
        var res;
    ...
    monitorDirectory: function(dirname) {
        ...
        dirWatcher
            .on('add', function(filepath) {
                injections.registerJsonFile(filepath);
            })
            .on('change', function(path) {
                injections.registerJsonFile(filepath);
            })
            .on('unlink', function(path) {
                injections.deregisterJsonFile(filepath);
            });
...
injections.monitorDirectory(jsonWatch.jsonExtensionDir);
