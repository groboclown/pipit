...
const requestedUrl = require('../lib/requested-url');
const injections = require('../lib/aws-common/injections');
...
router.get('/:type', function(req, res, next) {
  ...
  var inj = [];
  injections['forEach' + type](
    function(serviceName, apiName, injectionName, jsPath) {
      inj.push({
        Service: serviceName,
        Api: apiName,
        Name: injectionName,
        JSPath: jsPath,
        InjectionUrl: requestedUrl + '/' + serviceName + '/' +
